...
class _FetchedClientsState extends State<FetchedClients> {
  ...
  Widget build(BuildContext context) {
    ...
    final cardWidth = isWeb ? 500.0 : (isTablet ? 420.0 : double.infinity);
    final cardPadding = isWeb ? 40.0 : (isTablet ? 28.0 : 16.0);
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            margin: EdgeInsets.symmetric(
              vertical: isWeb ? 48 : (isTablet ? 32 : 16),
              horizontal: isWeb ? 0 : (isTablet ? 24 : 8),
            ),
            padding: EdgeInsets.all(cardPadding),
            decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(isWeb ? 32 : 18),
              boxShadow: [
                BoxShadow(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: isWeb ? 32 : (isTablet ? 24 : 18)),
                Divider(thickness: 1.2, color: Colors.grey[200]),
                SizedBox(height: isWeb ? 24 : (isTablet ? 18 : 12)),
                Row(
                  children: [
                    Icon(Icons.phone, color: Colors.purple[300], size: 22),
                    SizedBox(width: 10),
                    Text("Contact: ", style: labelStyle),
                    Expanded(
                      child: Text(userCred['contact'] ?? '', style: valueStyle),
                    ),
                  ],
                ),
                SizedBox(height: 12),
                ...
                Row(
                  children: [
                    Icon(Icons.date_range, color: Colors.orange[300], size: 20),
                    SizedBox(width: 10),
                ...
                Row(
                  children: [
                    Icon(Icons.attach_money, color: Colors.teal[400], size: 22),
                    SizedBox(width: 10),
                    Text("Total: ", style: labelStyle),
                    Text(userCred['totalAmount'] ?? '', style: valueStyle),
                    SizedBox(width: 12),
                    Text("Paid: ", style: labelStyle),
                    Text(userCred['paidAmount'] ?? '', style: valueStyle),
                    SizedBox(width: 12),
                    Text("Remain: ", style: labelStyle),
                    Text(userCred['remainingAmount'] ?? '', style: valueStyle),
                  ],
                ),
                SizedBox(height: 12),
                Row(
                ...
                Row(
                  children: [
                    Icon(Icons.verified, color: Colors.blueGrey[400], size: 22),
                    SizedBox(width: 10),
                    Text("Status: ", style: labelStyle),
                    Text(userCred['paymentStatus'] ?? '', style: valueStyle),
                  ],
                ),
                  ...
                  child: ElevatedButton.icon(
                    style: ElevatedButton.styleFrom(
                      ...
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(isWeb ? 16 : 10),
                      ),
                      elevation: 6,
